...
namespace Microsoft.WindowsAzure.Commands.Utilities.Common
{
    ...
    public class SubscriptionData
    {
        ...
        {
            Binding serviceBinding = Microsoft.WindowsAzure.Commands.Utilities.Common.ConfigurationConstants.WebHttpBinding(0);
            string serviceEndpoint = string.IsNullOrEmpty(ServiceEndpoint) ?
                Microsoft.WindowsAzure.Commands.Utilities.Common.ConfigurationConstants.ServiceManagementEndpoint :
                ServiceEndpoint;
