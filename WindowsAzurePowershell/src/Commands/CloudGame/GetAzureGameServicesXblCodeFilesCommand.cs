...
namespace Microsoft.WindowsAzure.Commands.XblCompute
{
    ...
    public class GetAzureGameServicesXblCodeFilesCommand : AzureGameServicesHttpClientCommandBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            XblCodeFileCollectionResponse result = null;

            CatchAggregatedExceptionFlattenAndRethrow(() => { result = Client.GetXblCodeFiles(XblComputeName, XblGameServiceId).Result; });
            WriteObject(result);
        }
    }
}