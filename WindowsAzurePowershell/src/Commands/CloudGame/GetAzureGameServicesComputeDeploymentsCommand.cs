...
namespace Microsoft.WindowsAzure.Commands.CloudGame
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "AzureGameServicesComputeDeploymentReport"), OutputType(typeof(DeploymentData))]
    public class GetAzureGameServicesComputeDeploymentReportCommand : AzureGameServicesHttpClientCommandBase
    {
        ...
        protected override void Execute()
        {
            ...
            DeploymentData result = Client.GetComputeDeploymentsReport(CloudGameName, Platform).Result;
            WriteObject(result);
        }
    }
}