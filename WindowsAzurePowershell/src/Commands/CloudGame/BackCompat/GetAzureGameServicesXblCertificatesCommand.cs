...
namespace Microsoft.WindowsAzure.Commands.CloudGame.BackCompat
{
    ...
    /// <summary>
    /// Get the cloud game certificate.
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "AzureGameServicesXblCertificates"), OutputType(typeof(XblCertificateCollectionResponse))]
    [Obsolete("This cmdlet is obsolete. Please use Get-AzureGameServicesCertificates instead.")]
    public class GetAzureGameServicesXblCertificatesCommand : AzureGameServicesHttpClientCommandBase
    {
        ...
        protected override void Execute()
        {
            ...
            var result = Client.GetXblCertificates(XblComputeName).Result;
            WriteObject(result);
        }
    }
}