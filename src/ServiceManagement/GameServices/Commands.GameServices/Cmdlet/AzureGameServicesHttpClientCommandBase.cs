...
namespace Microsoft.WindowsAzure.Commands.GameServices.Cmdlet
{
    ...
    public class AzureGameServicesHttpClientCommandBase : AzurePSCmdlet
    {
        ...
        public override void ExecuteCmdlet()
        {
            try
            {
                ...
                this.WriteDebugLog(string.Format(
                    ...
                    this.HasCurrentSubscription ? this.CurrentContext.Subscription.Name + " : " + this.CurrentContext.Subscription.Id : "None",
                    DateTime.UtcNow));
